...
export const historicalPeriods: HistoricalPeriod[] = [
  {
    ...
    events: [
      ...
      { id: 103, year: 1961, description: "Юрий Гагарин — первый человек в космосе" },
      {
        ...
        year: 1965,
        description:
          "Алексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космослексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космослексей Леонов — первый выход в открытый космос лексей Леонов — первый выход в открытый космос"
      },
